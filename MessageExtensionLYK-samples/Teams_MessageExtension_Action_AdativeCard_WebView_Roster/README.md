...
<https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/msgext-action/nodejs>
...
In Azure portal, create a [Azure Bot resource](https://docs.microsoft.com/azure/bot-service/bot-service-quickstart-registration).
    ...
    - ***If you don't have an Azure account*** create an [Azure free account here](https://azure.microsoft.com/free/)
